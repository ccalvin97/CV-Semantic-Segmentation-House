...
_C.PIN_MEMORY = True ## True - dataloader不會使用虛擬記憶體, False - dataloader可以使用虛擬記憶體
_C.RANK = 0
...
_C.LOSS = CN()
_C.LOSS.USE_OHEM = False ## Ohem loss, Default is cross entropy
...
_C.DATASET = CN()
_C.DATASET.ROOT = '' ## data root dir, ex:'data/'
_C.DATASET.DATASET = 'cityscapes'
_C.DATASET.NUM_CLASSES = 19  ## label counts
_C.DATASET.TRAIN_SET = 'list/cityscapes/train.lst'
_C.DATASET.EXTRA_TRAIN_SET = ''  ##有一個額外功能, 可以設定model訓練到某epoch轉成訓練另一批training data, 這邊就是第二批data dir
...
_C.TRAIN.BASE_SIZE = 2048  ## used in multi_scale_aug , Notice to set a a proper number 
...
_C.TRAIN.MOMENTUM = 0.9 ## momentum on the optimiser
_C.TRAIN.WD = 0.0001 ## weight decay rate
_C.TRAIN.NESTEROV = False
_C.TRAIN.IGNORE_LABEL = -1

_C.TRAIN.BEGIN_EPOCH = 0
_C.TRAIN.END_EPOCH = 484  ## Notice 
_C.TRAIN.EXTRA_EPOCH = 0

_C.TRAIN.RESUME = False

_C.TRAIN.BATCH_SIZE_PER_GPU = 32  ## Notice
...
_C.TEST.BASE_SIZE = 2048 ## used in multi_scale_aug , Notice to set a a proper number 
